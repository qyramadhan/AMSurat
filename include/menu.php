...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        ...
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                ...
                <div class="logo-side center blue-grey darken-3">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                echo '<h5 class="dinas-side">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="dinas-side">DKPP - Dinas Ketahanan Pangan dan Perikanan</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. AW Sumarmo No. 44-46, Kembaran Kulon, Kecamatan Purbalingga, Kabupaten Purbalingga, Jawa Tengah 54312</p>';
                            }
                        }
                    ?>
                </div>
            ...
            <li class="no-padding">
                <?php
                    if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 2 || $_SESSION['admin'] == 3 OR $_SESSION['admin'] == 4){ ?>
                <ul class="collapsible collapsible-accordion">
                    <li>
            ...
            ?>
            <?php
                if($_SESSION['admin'] == 3 AND $_SESSION['admin'] == 4){ ?>
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">settings</i> Pengaturan</a>
                        <div class="collapsible-body">
