                                    ...
                                    <div class="col m5 hide-on-med-and-down">
                                        <form method="post" action="?page=ref">
                                            <div class="input-field round-in-box">
                                                <input id="search" type="search" name="cari" placeholder="Ketik nama referensi dan tekan enter mencari data..." required>
                ...
                $cari = mysqli_real_escape_string($config, $_REQUEST['cari']);
                    ...
                    <div class="col m12" id="colres">
                        <table class="bordered" id="tbl">
                            ...
                            $query = mysqli_query($config, "SELECT * FROM tbl_klasifikasi WHERE nama LIKE '%$cari%' ORDER BY id_klasifikasi ASC LIMIT 50");
