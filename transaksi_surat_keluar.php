                                    ...
                                    while($row = mysqli_fetch_array($query)){
                                      ...
                                      <tr>
                                        ...
                                        if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] == 3){
                                            echo '
                                                 <a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctkk&id_surat='.$row['id_surat'].'" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>';
                                        } elseif ($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] == 4) {
                                            echo '<a class="btn small yellow darken-3 waves-effect waves-light" href="?page=ctkk&id_surat='.$row['id_surat'].'" target="_blank">
                                                <i class="material-icons">print</i> PRINT</a>';
                                        } else {
