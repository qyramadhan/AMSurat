                    ...
                    <div class="card-content">
                        ...
                        <?php
                            if($_SESSION['admin'] == 1){
                                ...
                                echo "<strong>Pendisposisi Surat</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                            } else {
                                echo "<strong>Staff atau Pegawai</strong>. Berikut adalah statistik data yang tersimpan dalam sistem.";
                            }?></p>
                    </div>
                </div>
            </div>
