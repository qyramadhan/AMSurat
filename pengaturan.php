        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['sub'])){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if ($_REQUEST['institusi'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['status'] == "" || $_REQUEST['alamat'] == "" || $_REQUEST['kadin'] == "" || $_REQUEST['nip'] == ""
                        ...
                        if(!preg_match("/^[a-zA-Z0-9. -]*$/", $nama)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9. -]*$/", $institusi)){
                                $_SESSION['institusi'] = 'Form Asal Pemerintah Kabupaten/Kota hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan minus(-)';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.,:\/<> -\"]*$/", $status)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $alamat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z., ]*$/", $kadin)){
                                            $_SESSION['kadin'] = 'Form Nama Kepala Dinas hanya boleh mengandung karakter huruf, spasi, titik(.) dan koma(,)<br/><br/>';
                                            echo '<script language="javascript">window.history.back();</script>';
                                        } else {

                                            if(!preg_match("/^[0-9 -]*$/", $nip)){
                                                $_SESSION['nipkepsek'] = 'Form NIP Kepala Dinas hanya boleh mengandung karakter angka, spasi, dan minus(-)<br/><br/>';
                                                echo '<script language="javascript">window.history.back();</script>';
                                            } else {
                                                        ...
                                                        if(!empty($logo)){
                                                            ...
                                                            if(in_array($eks, $ekstensi) == true){
                                                                if($ukuran < 2000000){
                                                                    ...
                                                                    $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',kadin='$kadin',nip='$nip',website='$website',email='$email',logo='$nlogo',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_instansi SET institusi='$institusi',nama='$nama',status='$status',alamat='$alamat',kadin='$kadin',nip='$nip',website='$website',email='$email',id_user='$id_user' WHERE id_instansi='$id_instansi'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="institusi" type="text" class="validate" name="institusi" value="<?php echo $row['institusi']; ?>" required>
                                            ...
                                            ?>
                                        <label for="institusi">Asal Instansi</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="kadin" type="text" class="validate" name="kadin" value="<?php echo $row['kadin']; ?>" required>
                                            <?php
                                                if(isset($_SESSION['kadin'])){
                                                    $kadin = $_SESSION['kadin'];
                                                    echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$kadin.'</div>';
                                                    unset($_SESSION['kadin']);
                                                }
                                            ?>
                                        <label for="kadin">Nama Dekan</label>
                                    </div>
                                    <div class="input-field col s6">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <input id="nip" type="text" class="validate" name="nip" value="<?php echo $row['nip']; ?>" required>
                                            ...
                                            ?>
                                        <label for="nip">NIP/NIDN Dekan</label>
                                    </div>
                                    <div class="input-field col s6">
